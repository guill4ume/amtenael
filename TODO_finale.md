...
- [x] **Documentation Wiki** : 
  - [ ] Recenser ce qui fonctionne en craft/classes sur DOL.
  - [ ] Recenser monstres et quêtes (et page loot Boss Ma'ati).
...
- [ ] **PNJs & Services** : 
  ...
  - [ ] Passer tous les gardes/NPC en neutre sur la carte 51.
- [ ] **Infrastructure & QA** :
...
- [x] **Groupage Inter-Royaume (Client 1.127)** :
  ...
  - [ ] **Améliorations futures** : Ajouter confirmation du joueur invité + popup visuelle.
